...
export const PLANS = {
  free: { name: "Free", monthly: 0, yearly: 0, liveLimit: 3, seats: 0, pdf: false, brand: false, protect: false, notify: false, payment: false, countersign: false, footerOff: false, images: 10 },
  pro: { name: "Pro", monthly: 24, yearly: 19, liveLimit: Infinity, seats: 0, pdf: true, brand: true, protect: true, notify: true, payment: true, countersign: false, footerOff: true, images: 200 },
  business: { name: "Business", monthly: 69, yearly: 59, liveLimit: Infinity, seats: 10, pdf: true, brand: true, protect: true, notify: true, payment: true, countersign: true, footerOff: true, images: 500 },
...
export function capsOf(user: Pick<User, "plan" | "trialEndsAt">, now = new Date()): Caps {
  ...
  return { liveLimit: p.liveLimit, seats: p.seats, pdf: p.pdf, brand: p.brand, protect: p.protect, notify: p.notify, payment: p.payment, countersign: p.countersign, footerOff: p.footerOff, images: p.images };
}
