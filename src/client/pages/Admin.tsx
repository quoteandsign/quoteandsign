      ...
      <main className="mx-auto max-w-5xl px-5 pb-32 pt-10 sm:px-8">
        ...
        {tab === "settings" && (
          <section className="mt-5 max-w-xl rounded-[1.25rem] bg-white p-6 shadow-[0_1px_1px_rgba(25,24,22,.04),0_12px_32px_-20px_rgba(25,24,22,.35)] ring-1 ring-inset ring-stone-900/[.035] dark:bg-stone-900 dark:shadow-none dark:ring-white/[.08]" data-test="indexnow">
            ...
            <p className="mt-1 text-[13.5px] leading-relaxed text-stone-500">Every public page is sent to IndexNow (Bing, and the assistants that search through it) automatically once a day when the list changes. Deploying also submits from your own machine (npm run deploy does it at the end), which is the reliable route: IndexNow sometimes throttles requests from Cloudflare's shared addresses, and this button then answers 429. Google does not take IndexNow; for Google, resubmit the sitemap in Search Console.</p>
